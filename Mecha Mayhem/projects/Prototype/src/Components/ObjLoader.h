...
public:
	...
	static void PerformDraw(const glm::mat4& view, const Camera& camera, const glm::vec3& colour, const glm::vec3 lightPos[], const glm::vec3 lightColour[], const int& lightCount,
